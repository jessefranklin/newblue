...
class evowi_admin{
	...
	// custom columns
		...
		function column_display( $column_name, $post_id ) {
		    ...
		    $count = $this->fnc->get_wishlist_count($post_id, 0);
		    echo $count;
		}
	...
	function evowi_language_additions($_existen){
		$new_ar = array(
				...
				array('label'=>'Unlike','var'=>'1'),
				array('label'=>'Like','var'=>'1'),
				...
				array('label'=>'You can view and manage the events you have added to your wishlist from here. Past events in your wishlist will not show in here.','var'=>'1'),
				array('type'=>'togend'),
			);

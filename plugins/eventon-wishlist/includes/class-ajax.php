...
class evowi_ajax{
	...
	function evowi_change_wishlist(){
		...
		if(!is_user_logged_in()){
			...
			$current_page = sanitize_text_field($_POST['pl']);

			?>
				<div style='text-align:center;padding:20px;'>

					<?php do_action('evowi_nologin_before_content', $_POST['eid']);?>
					...
					<?php do_action('evowi_nologin_after_content', $_POST['eid']);?>
